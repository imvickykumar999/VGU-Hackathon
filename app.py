...
def converted_yourquotes():
    ...
    if otp == getotp and otp != '-':
        if person == '':
            obj1 = crud.vicks(credentials, link = 'https://home-automation-336c0-default-rtdb.firebaseio.com/')
        else:
            # print(credentials)
            obj1 = crud.vicks(credentials, name = person, link = 'https://home-automation-336c0-default-rtdb.firebaseio.com/')
